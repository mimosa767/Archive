...
public class Scroll
{
  ...
  public static void scrollKeys(AndroidDriver driver, String[] list)
  {
    ...
    for (int i = 0; i < list.length; i++)
    {
      ...
      //touchAction6.longPress(me, Duration.ofSeconds(1)).release();
      touchAction6.longPress(LongPressOptions.longPressOptions().withDuration(Duration.ofSeconds(1)).withElement(ElementOption.element(me))).release();
